<template>
    <div class="DepSalesDrug content_inner">
        <div class="Form">
            <div class="classify"><h4 class="title">药房提货{{this.org_name}}</h4></div>
            <div id="baseinfo" style="border-bottom: 1px solid #dfdfdf;padding-bottom: 5px;">
                ...
                <el-row :gutter="1" class="baseinfo">
                    ...
                    <el-col :span="6">
                        <span class="base-label">售药价格：</span>
                ...
                <el-row :gutter="1" class="baseinfo">
                    ...
                    <div id="buttons" style="float:right;margin:0 20px 5px 0;">
                        <el-button type="primary" style="width:70px" size="mini"  @click="GetBussNo">提 货</el-button>
                    </div>
                </el-row>
    ...
    export default {
        ...
        methods:{
            ...
            SaveDrugProduct(){
                ...
                this.$http.post(baseUrl()+'/comm',{"methodName":"sp_clinic_library_drug_store_save","param":param}).then((response) => {
                    if(requestSuccess(response.body,this)){
            ...
            GetBatch(drug_product_id){
                let param={
                    "hospital_id":hospital_id,
                    "goods_id":drug_product_id
                };
                this.$http.post(baseUrl()+'/comm',{"methodName":"sp_clinic_library_rest","param":JSON.stringify(param)}).then((response) => {
                    if(requestSuccess(response.body,this)) {
